...
def check_wheel_content(wheel_archive, expected_distribution_name, expected_content, pure=False):
    ...
    with ZipFile(wheel_archive) as archive:
        ...
        # software that produced the archive. Wheels are now generated by
        # plain setuptools/wheel rather than a custom bdist_wheel command.
        ...
        assert current_generator.startswith((b"setuptools", b"bdist_wheel"))
